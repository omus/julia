...
getindex(A::Array, i1::Real, I::Real...) = arrayref(A, to_index(i1), to_indexes(I...)...)
...
## Indexing: setindex! ##
setindex!{T}(A::Array{T}, x, i1::Real, I::Real...) = arrayset(A, convert(T,x), to_index(i1), to_indexes(I...)...)
